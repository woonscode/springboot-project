...
import ReturnPassData from '/src/services/gop/ReturnPassData'
...
const ReturnPassTable = ({confiOpen}) => {
    ...
    try {
        ...
        if (res.status == 200) {
            ...
            for (var index in loanData) {
                ...
                if (loan.collected && !loan.returned) {
                    let passIds = []
...
export default ReturnPassTable
